...
model Controlled_Building_2
  ...
  AES_project_2023_2024.ProcessComponents.TePrad tePrad1(Temax(displayUnit = "degC"), Temin (displayUnit = "degC")) annotation(
    Placement(transformation(origin = {1096, 482}, extent = {{-38, -38}, {38, 38}}, rotation = -90)));
  ...
  AES.ControlBlocks.ActuationSchemes.SplitRange01 splitRange1 annotation(
    Placement(transformation(origin = {293, 207}, extent = {{-39, -41}, {39, 41}})));
  ...
  AES.ControlBlocks.ActuationSchemes.SplitRange01 splitRange12 annotation(
    Placement(transformation(origin = {291, 17}, extent = {{-41, -45}, {41, 45}})));
  ...
  Modelica.Blocks.Continuous.FirstOrder system1(T = 1000, initType = Modelica.Blocks.Types.Init.InitialOutput, k = 1, y_start = 273.15) annotation(
    Placement(transformation(origin = {-1077, 413}, extent = {{-47, -47}, {47, 47}})));
...
equation
  ...
  connect(tePrad1.Te, building_ee.Te) annotation(
    Line(points = {{1118.8, 436.4}, {1118.8, 354.9}, {1272, 354.9}, {1272, 283}}, color = {0, 0, 127}));
  connect(tePrad1.Prad, building_ee.PRad) annotation(
    Line(points = {{1073.2, 436.4}, {1073.2, 354.4}, {1211.5, 354.4}, {1211.5, 280}}, color = {0, 0, 127}));
  ...
  connect(scheduler.h1out, splitRange1.CSi01) annotation(
    Line(points = {{146.04, 186.4}, {246.04, 186.4}, {246.04, 207.4}}, color = {0, 0, 127}));
  connect(splitRange1.CSo01_pos, HC1.uh01) annotation(
    Line(points = {{339.8, 231.6}, {339.8, 241.6}, {447.8, 241.6}}, color = {0, 0, 127}));
  connect(HC1.uc01, splitRange1.CSo01_neg) annotation(
    Line(points = {{448.8, 198.4}, {352.8, 198.4}, {352.8, 182.4}, {340.8, 182.4}}, color = {0, 0, 127}));
  ...
  connect(scheduler.h3out, splitRange12.CSi01) annotation(
    Line(points = {{147.2, 50.68}, {199.7, 50.68}, {199.7, 16.68}, {242.2, 16.68}}, color = {0, 0, 127}));
  connect(HC3.uh01, splitRange12.CSo01_pos) annotation(
    Line(points = {{450.4, 14.8}, {396.4, 14.8}, {396.4, 44.8}, {340.4, 44.8}}, color = {0, 0, 127}));
  connect(splitRange12.CSo01_neg, HC3.uc01) annotation(
    Line(points = {{340.2, -10}, {450.2, -10}, {450.2, -30}}, color = {0, 0, 127}));
  ...
  connect(SetPointTable.y[1], system1.u) annotation(
    Line(points = {{-1196.9, 281}, {-1182.4, 281}, {-1182.4, 413}, {-1132.9, 413}}, color = {0, 0, 127}));
  ...
  connect(system1.y, strictController.setpoint1) annotation(
    Line(points = {{-1025.3, 413}, {-935.3, 413}, {-935.3, 273}, {-505.3, 273}}, color = {0, 0, 127}));
  ...
  connect(system3.y, strictController.setpoint3) annotation(
    Line(points = {{-1036.9, 17}, {-510.9, 17}, {-510.9, 69}, {-506.9, 69}}, color = {0, 0, 127}));
