...
model Controlled_Building_2
  ...
  StrictController strictController(Tau = 1, TauHC = 1/10, TauZero = 10)  annotation(
...
equation
  ...
  connect(T3.y, strictController.y_meas3) annotation(
  ...
  connect(T3.y, loose_Controller.T3) annotation(
    Line(points = {{-678, 104}, {-638, 104}, {-638, -48}, {-436, -48}}, color = {0, 0, 127}));
  annotation(
