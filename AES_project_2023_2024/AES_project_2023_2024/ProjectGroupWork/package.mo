...
package ProjectGroupWork
  ...
  model RoomWithHeater
    ...
    Modelica.Electrical.Analog.Interfaces.Pin pin1 annotation(
      Placement(transformation(origin = {0, 66}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {0, 50}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Blocks.Interfaces.RealInput PowerIn annotation(
      Placement(transformation(origin = {-58, -8}, extent = {{-20, -20}, {20, 20}}, rotation = 180), iconTransformation(origin = {-200, -34}, extent = {{-20, -20}, {20, 20}}, rotation = 180)));
    ...
    Modelica.Blocks.Interfaces.RealOutput t annotation(
      Placement(transformation(origin = {44, -8}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {190, -32}, extent = {{-12, -12}, {12, 12}})));
    parameter String name="Room";
  Modelica.Electrical.Analog.Interfaces.Pin pin11 annotation(
      Placement(transformation(origin = {18, 66}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-2, -134}, extent = {{-10, -10}, {10, 10}})));
  equation
    ...
    connect(pin1, capacitor.p) annotation(
      ...
      connect(pin11, signalCurrent.n) annotation(
      Line(points = {{18, 66}, {18, 0}, {-18, 0}}, color = {0, 0, 255}));
    connect(pin11, capacitor.p) annotation(
      Line(points = {{18, 66}, {18, 0}}, color = {0, 0, 255}));
    annotation(
      Icon(coordinateSystem(extent = {{-179, 41}, {179, -124}}), graphics = {Rectangle( fillColor = {135, 206, 250}, fillPattern = FillPattern.Solid, extent = {{-179, 41}, {179, -124}}), Text(origin = {0, -41}, extent = {{-178, 81}, {178, -81}}, textString = name)}),
      Diagram);
  end RoomWithHeater;
  ...
  model WallWithDoor
    ...
    parameter Real Cw;
    parameter Real Tstart;
    parameter String name=WallWithDoors;
    ...
    Modelica.Electrical.Analog.Interfaces.Pin pin1 annotation(
      Placement(transformation(origin = {-76, 0}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {130, 34}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Electrical.Analog.Interfaces.Pin pin2 annotation(
      Placement(transformation(origin = {94, 0}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {132, -86}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Blocks.Interfaces.BooleanInput doorin annotation(
      Placement(transformation(origin = {-32, 62}, extent = {{-20, -20}, {20, 20}}, rotation = 90), iconTransformation(origin = {60, 44}, extent = {{-20, -20}, {20, 20}}, rotation = 90)));
  ...
  equation
    ...
    annotation(
      Icon(coordinateSystem(extent = {{-201, 25}, {501, -76}}), graphics = {Rectangle( fillColor = {255, 165, 0}, fillPattern = FillPattern.Solid, extent = {{-200, 24}, {500, -75}}), Text(origin = {145, -27}, rotation = 180, extent = {{-340, 42}, {340, -42}}, textString = name)}),
      Diagram);
  end WallWithDoor;
  ...
  model WallWithoutDoors
    ...
    Modelica.Electrical.Analog.Interfaces.Pin pin1 annotation(
      Placement(transformation(origin = {-2, 26}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {0, 34}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Electrical.Analog.Interfaces.Pin pin2 annotation(
      Placement(transformation(origin = {-2, -66}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {0, -82}, extent = {{-10, -10}, {10, 10}})));
    parameter Real Gin;
    parameter Real Gext;
    parameter Real C;
    parameter Real Tstart;
  ...
  equation
    ...
    annotation(
      Icon(coordinateSystem(extent = {{-353, 23}, {352, -72}}), graphics = {Rectangle(fillColor = {165, 42, 42}, fillPattern = FillPattern.Solid, extent = {{-353, 23}, {352, -72}}), Text(origin = {0, 0}, extent = {{-353, 23}, {352, -72}}, textString = name)}));
  ...
  model Outside
    ...
    Modelica.Blocks.Interfaces.RealInput Te annotation(
      Placement(transformation(origin = {28, -28}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {68, -2}, extent = {{-20, -20}, {20, 20}})));
  equation
  ...
  model WallWithDoorAndRadiation
    ...
    Modelica.Electrical.Analog.Interfaces.Pin pinOut annotation(
      Placement(transformation(origin = {-92, 4}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-86, -4}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Electrical.Analog.Interfaces.Pin pinIn annotation(
      Placement(transformation(origin = {80, 2}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {36, -4}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Blocks.Interfaces.BooleanInput doorin annotation(
      Placement(transformation(origin = {-30, 60}, extent = {{-20, -20}, {20, 20}}, rotation = 90), iconTransformation(origin = {-98, 34}, extent = {{-20, -20}, {20, 20}}, rotation = 180)));
    Modelica.Electrical.Analog.Sources.SignalCurrent signalCurrent annotation(
      Placement(transformation(origin = {-28, -34}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
    Modelica.Blocks.Interfaces.RealInput Prad annotation(
      Placement(transformation(origin = {-62, -38}, extent = {{-20, -20}, {20, 20}}, rotation = 180), iconTransformation(origin = {-26, -218}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
  ...
  equation
    ...
    annotation(
      Icon(coordinateSystem(extent = {{24, -200}, {-75, 199}}), graphics = {Rectangle( rotation = -90, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, extent = {{-200, 24}, {199, -75}}), Text(origin = {-17, -5}, rotation = -90, extent = {{-197, 49}, {197, -49}}, textString = name)}),
