...
model StrictController
  AES_project_2023_2024.ProjectGroupWork.Split_Equalizer split_Equalizer annotation(
    Placement(transformation(origin = {-17, 69}, extent = {{-22, -22}, {22, 22}})));
  AES_project_2023_2024.ProjectGroupWork.Split_Equalizer split_Equalizer1 annotation(
    Placement(transformation(origin = {-23, -9}, extent = {{-18, -18}, {18, 18}})));
  AES_project_2023_2024.ProjectGroupWork.Split_Equalizer split_Equalizer2 annotation(
    Placement(transformation(origin = {-22, -84}, extent = {{-17, -17}, {17, 17}})));
  Modelica.Blocks.Interfaces.RealInput y_meas1 annotation(
    Placement(transformation(origin = {-82, 88}, extent = {{-20, -20}, {20, 20}}, rotation = 180), iconTransformation(origin = {-100, 102}, extent = {{-20, -20}, {20, 20}}, rotation = 180)));
...
equation
  connect(split_Equalizer.y_meas, y_meas1) annotation(
    Line(points = {{-48, 87}, {-65, 87}, {-65, 88}, {-82, 88}}, color = {0, 0, 127}));
