...
model StrictController
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter11(uMax = 4000, uMin = -1000) annotation(
    Placement(transformation(origin = {-116, -222}, extent = {{-10, -10}, {10, 10}})));
...
equation
  ...
  connect(add3.y, limiter11.u) annotation(
    Line(points = {{-179, -222}, {-129, -222}}, color = {0, 0, 127}));
  ...
  connect(add2.y, limiter111.u) annotation(
    Line(points = {{-225, -28}, {-197.5, -28}, {-197.5, -22}, {-176, -22}}, color = {0, 0, 127}));
  connect(Ti2.u, limiter111.y) annotation(
  ...
  connect(add1.y, limiter112.u) annotation(
    Line(points = {{-247, 88}, {-196, 88}}, color = {0, 0, 127}));
  connect(Ti1.u, limiter112.y) annotation(
  ...
  connect(limiter112.y, CompensatorTe1.u1) annotation(
    Line(points = {{-172, 88}, {-134, 88}, {-134, 84}, {-92, 84}}, color = {0, 0, 127}));
  connect(add31.y, CompensatorTe1.u2) annotation(
    Line(points = {{-128, 20}, {-128, 22}, {-92, 22}, {-92, 72}}, color = {0, 0, 127}));
  ...
  connect(CompensatorTe2.u1, limiter111.y) annotation(
    Line(points = {{-70, -22}, {-153, -22}}, color = {0, 0, 127}));
  connect(limiter11.y, Ti3.u) annotation(
    Line(points = {{-105, -222}, {-73, -222}, {-73, -254}, {-105, -254}}, color = {0, 0, 127}));
  connect(CompensatorTe3.u1, limiter11.y) annotation(
    Line(points = {{-58, -222}, {-104, -222}}, color = {0, 0, 127}));
  ...
  connect(CompensatorTe1.y, add51.u1) annotation(
    Line(points = {{-69, 78}, {202, 78}}, color = {0, 0, 127}));
