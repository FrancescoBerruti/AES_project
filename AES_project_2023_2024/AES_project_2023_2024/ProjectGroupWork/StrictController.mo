...
model StrictController
  ...
  Modelica.Blocks.Math.Add CompensatorTe1(k2 = -154.286/2) annotation(
  ...
  Modelica.Blocks.Math.Add CompensatorTe2(k2 = -102.857/2) annotation(
    Placement(transformation(origin = {-58, -28}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Math.Add CompensatorTe3(k2 = -257.143/2) annotation(
...
equation
  ...
  connect(split_equalizer.Prequested, CompensatorTe1.y) annotation(
  ...
  connect(split_equalizer1.Prequested, CompensatorTe2.y) annotation(
  ...
  connect(split_equalizer2.Prequested, CompensatorTe3.y) annotation(
