...
protected
  ...
  equation
    ...
    Cr1*der(Tr1)   = Phr1-Pcr1+Pdr1-Pr1w1e;
    Cr2*der(Tr2)   = Phr2-Pcr2+Pdr2-Pr2w2e;
    Cr3*der(Tr3)   = Phr3-Pcr3+Pdr3-Pr3w3e-Pdoor3e;
  ...
  annotation(
      Icon(coordinateSystem(extent = {{-200, -300}, {200, 300}}), graphics = {Rectangle(origin = {-1, -1}, fillColor = {255, 255, 127}, fillPattern = FillPattern.Solid, extent = {{-200, 300}, {200, -300}}), Text(origin = {-2, 1}, extent = {{-116, 163}, {116, -163}}, textString = "Building_noWalls")}),
  experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-6, Interval = 0.002),
  __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian",
  __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"));
end Building_noConns;
